                ...
                <div className="flat-title t1">
                  ...
                  >
                    ...
                    <h2 className="title-section mg-b26 color-d12">
                      Hi, I am here to{" "}
                      <span className="color-d4">help you.</span>
                    </h2>
                    <p>
                      Hi, if you need a website for your business, then
                      you can tell me, I'm here to help you.
                    </p>
                    <p>
                      I am Sara, I build and design beautiful creative User Interfaces
                      for a reasonable price, responsive websites that suit your needs. 
                    </p>
                  </div>
                  <div
                  ...
                  >
                    <div className="fl-btn btn-general">
                      <a href="https://www.linkedin.com/in/sara-uras-11619a166/" className="f-w500 color-1 lt-sp07">
                        Hire Me
                      </a>
                    </div>
                  </div>
